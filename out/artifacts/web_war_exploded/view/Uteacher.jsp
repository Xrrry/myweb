    ...
    <div class="row">
        <div class="sidebar col-sm-3 col-md-2">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="grades.jsp?page=1">院系列表</a></li>
                <li><a href="teachers.jsp?page=1">教师列表<span
        ...
        <div>
            <form method="post" action="<%=request.getContextPath()%>/TeacherServlet?method=update">
                <%
