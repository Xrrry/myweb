...
<div class="container-fluid">
    <div class="row">
        ...
        <div>
            <form method="post" action="<%=request.getContextPath()%>/GradeServlet?method=update">
                <%
                ...
                <div class="input-group form-signin" style="max-width: 400px;">
                    ...
                    <input name="name" type="text" class="form-control" value="<%=g.getGradeName()%>" required><br>
                </div>
